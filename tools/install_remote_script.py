...
SOURCE = REPO_ROOT / "remote-script" / "AbletonAgentBridge"
...
def install(target_root, dry_run=False):
    ...
    target = target_root / "Remote Scripts" / "AbletonAgentBridge"
    ...
    print("installed")
    print("restart Ableton Live, then select AbletonAgentBridge as a Control Surface.")


def main():
    parser = argparse.ArgumentParser(description="Install AbletonAgentBridge into the User Library.")
